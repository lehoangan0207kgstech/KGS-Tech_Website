...
const BlogComponent = () => {
  ...
  const blogs = [
    {
      id: 1,
      image: "https://www.advisorpedia.com/media/2017/10/5-major-advantages-of-employees-working-from-the-office.jpg",
    ...
    {
      id: 3,
      image: "https://res.cloudinary.com/momentum-media-group-pty-ltd/image/upload/v1655714496/MyBusiness/new_articleimage/employees-office-myb.jpg",
    ...
    {
      id: 4,
      image: "https://th.bing.com/th/id/OIP.rm8qRvfsjSx6TrI-cdFqAQAAAA?w=417&h=626&rs=1&pid=ImgDetMain",
  ...
  return (
    <section className="py-10">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-extrabold text-accent text-center mb-8">{t("blog.title")}</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {blogs.map((blog) => (
            <div key={blog.id} className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
