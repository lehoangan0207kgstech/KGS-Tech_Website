...
const BlogDetail = () => {
  ...
  const blogData = {
    ...
    image: "https://phunugioi.com/wp-content/uploads/2020/04/hinh-anh-em-be-de-thuong-ngo-nghinh-dang-yeu.jpg", // Thay bằng URL thật
  };
  ...
  return (
    <div className="container mx-auto px-4 py-24">
      <div className="max-w-4xl mx-auto">
        {/* Tiêu đề */}
        <h1 className="text-3xl font-bold mb-4 text-center">{blogData.title}</h1>
