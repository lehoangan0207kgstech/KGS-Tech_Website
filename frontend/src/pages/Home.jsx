...
const Home = () => {
  ...
  const features = [
    {
      ...
      image:
        "https://images.spiceworks.com/wp-content/uploads/2021/12/14163643/working_culture_is_the_part_of_business_success_5d8cd5099e53a.jpg",
    ...
    },
    {
      ...
      image:
        "https://www.companybug.com/wp-content/uploads/2019/05/pexels-photo-1153213.jpeg",
      bgColor: "bg-cover bg-center",
    },
    {
  ...
  return (
    ...
    >
      {/* Banner Section */}
      <motion.div
        className="relative w-full h-[100vh] bg-cover bg-top"
        style={{
          backgroundImage:
